...
loop int i = 1 until i > picPairs.count()
	begin
				...
				#	term.print_line(out[1]+out[2]);	
				#	term.print_line(freePos);		
				#end;
				...
				#Selbox
				picStim.set_part_x(14,(spacing * (XX - (SPALTEN+1)/2))-spacing/2);
				#picStim.set_part_x(41,160* (8 - (SPALTEN1)/2));
				picStim.set_part_y(14,-spacing * (YY- (ZEILEN+1)/2));
				
				picStim.set_part_x(15,(spacing * (XX - (SPALTEN+1)/2))-spacing/2);
				#picStim.set_part_x(41,160* (8 - (SPALTEN1)/2));
				picStim.set_part_y(15,-spacing * (YY- (ZEILEN+1)/2));
